...
#define SWIGTYPE_p_unsigned_long_long swig_types[3]
...
/*-----------------------------------------------
              @(target):= _pywrap_tensorflow_print_model_analysis_lib.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__pywrap_tensorflow_print_model_analysis_lib

#else
#  define SWIG_init    init_pywrap_tensorflow_print_model_analysis_lib

#endif
#define SWIG_name    "_pywrap_tensorflow_print_model_analysis_lib"
